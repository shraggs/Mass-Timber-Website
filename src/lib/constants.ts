export const SITE_NAME = 'IW Mass Timber';
export const SITE_TAGLINE = 'Expert Fabrication for Mass Timber Construction. Built on Ironworker Precision.';
export const CONTACT_EMAIL = 'info@iwmasstimber.com';
export const CONTACT_PHONE = '(202) 383-4800';
export const CONTACT_PHONE_SECONDARY = '(800) 555-1212';
export const BUSINESS_HOURS = 'Monday - Friday: 7 AM – 6 PM';
