...
export const metadata = {
  title: 'What is Mass Timber? | Ironworkers Mass Timber',
  description: 'Learn about Mass Timber construction from an Ironworker perspective — engineered wood products designed for structural performance.',
};

export default function WhatIsMassTimberPage() {
  return (
    <>
      <PageBanner
        title="What is Mass Timber?"
        subtitle="Engineered wood products designed for structural performance"
        backgroundImage="/images/timber-ceiling.png"
        breadcrumbs={[
          { label: 'Home', href: '/' },
